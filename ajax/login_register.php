...
function send_mail($uemail, $token, $type)
{
    ...
    try {
        ...
        $mail->Username = 'np03cs4s230134@heraldcollege.edu.np';                // Your () SMTP username
        $mail->Password = 'xbrb ddqm obos ksxz';                // Your  SMTP password
...
if (isset($_POST['register'])) {
    ...
    // Use for if using email verification
    /*
