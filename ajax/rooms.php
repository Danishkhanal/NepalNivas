...
<div class='card mb-4 border-0 shadow'>
  <div class='row g-0 p-3 align-items-center'>
    ...
    <div class='col-md-2 mt-lg-0 mt-md-0 mt-4 text-center'>
      ...
      $book_btn
      <a href='room_details.php?id=$room_data[id]&currency=$selected_currency' class='btn btn-sm w-100 btn-outline-dark shadow-none'>More details</a>
    </div>
  </div>
</div>
";
  ...
  // Function to get exchange rate from database
