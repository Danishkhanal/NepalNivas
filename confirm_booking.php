...
<body class="bg-light">
  ...
  <?php 
    ...
    function convertCurrency($amount, $from_currency, $to_currency, $con) {
      ...
      return number_format($amount, 2); // Return original amount if rates are unavailable
    }
    ...
    */
    ...
    $base_currency = 'NPR';
    $converted_price = convertCurrency($room_data['price'], $base_currency, $selected_currency, $con);
              ...
              <div class="row">
                ...
                <div class="col-12 mb-3">
                  ...
                  <?php if(isset($_GET['error']) && $_GET['error'] == 'invalid_payment'): ?>
                    <div class="alert alert-danger mb-2">Invalid payment method selected for the chosen currency.</div>
                  <?php endif; ?>
      ...
      if(checkin_val!='' && checkout_val!='')
      {
        ...
        xhr.onload = function()
        {
          ...
          if(data.status == 'check_in_out_equal'){
            ...
            pay_info.innerHTML = "No. of Days: "+data.days+"<br>Total Amount to Pay: "+data.currency+" "+data.payment;
